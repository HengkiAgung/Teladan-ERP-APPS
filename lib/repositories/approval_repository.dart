...
class ApprovalRepository {
  ...
  Future<List<Assignment>> getAssignmentApproval({String page = "1", required String token,}) async {
  ...
  Future<Assignment> getAssignmentApprovalDetail({required String token, required int id}) async {
    final response = await http.get(
  ...
  Future<bool> updateStatusRequestAssigment({required String status, required int id}) async {
    String? token = await Auth().getToken();
