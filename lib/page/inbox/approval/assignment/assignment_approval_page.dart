...
class _AssignmentApprovalPageState extends State<AssignmentApprovalPage> {
  ...
  Widget build(BuildContext context) {
    final userAssignmentApproval = BlocProvider.of<ApprovalAssignmentListBloc>(context);
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: BlocBuilder<ApprovalAssignmentListBloc, ApprovalAssignmentListState>(
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            } else if (userAssignmentApproval.status == "Approved") {
                            ...
                            return Container(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  context.read<ApprovalAssignmentDetailBloc>().add(
                                      GetRequestAssigmentDetail(id: userAssignmentApproval.id));
          ...
          GestureDetector(
            onTap: () async {
              final Uri url = Uri.parse('${Config.url}/operation/assignment/create');
