    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: InkWell(
          onTap: () async {
            if (_signedById == null) {
              ModalBottomSheetComponent().errorIndicator(context, "Signed By wajib diisi!");
            } else {
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment:
                          CrossAxisAlignment.start,
                      children: [
                        Text("latitude: $lat", style: GoogleFonts.poppins(
                          fontSize: 15,
                        ),),
                        Text("longitude: $long", style: GoogleFonts.poppins(
                          fontSize: 15,
                        ),),
                      ],
                    ),
