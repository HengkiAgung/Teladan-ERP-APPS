                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            } else if (userAssignmentRequest.status == "Approved") {
                            ...
                            return Container(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  context.read<RequestAssignmentDetailBloc>().add(
                                      GetRequestAssigmentDetail(id: userAssignmentRequest.id));

                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          DetailAssignmentRequestPage(id: userAssignmentRequest.id),
                                    ),
                                  );
                                },
                                child: Padding(
