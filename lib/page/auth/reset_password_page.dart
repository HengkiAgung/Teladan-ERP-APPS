        ...
        child: ListView(
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Sepertinya ini pertama kali anda login",
            ...
            Padding(
              ...
              child: TextButton(
                onPressed: () async {
                  if (await Auth().resetPassword(context, _passwordController.text) ) {
                    Auth().logOut(context);
                  }
                  ModalBottomSheetComponent().loadingIndicator(context, "Berhasil mengganti password, silahkan login ulang");
